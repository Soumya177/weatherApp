...
//   name='user_name'required value={fullName} onChange={(e)=>setFullName(e.target.value)} style={{height:"50px"}}/>
//   <input type="Email"
//   placeholder='Email'
//   name='user_email'required onChange={(e)=>setEmail(e.target.value)} style={{height:"50px"}}/>
//   <input type="text"
//   placeholder='Subject'
//   name='subject'required onChange={(e)=>setSubject(e.target.value)} style={{height:"50px"}}/>
